  ...
  return (
    <div className="home_page">
      <Box textAlign='center'>
        <Heading className="emptyElement" as='h4' size='md'>Shop By Category</Heading>
      </Box>
      <Crousel arr={arr} />
      <SoloImageCrousel arr={largeArr} />
      <Box className="black_bcg">
        <img src='https://cdn.plotch.io/image/upload/C/V/1660916598_MS5wbmc=.png' />
        <img src='https://cdn.plotch.io/image/upload/C/V/1660916607_Mi5wbmc=.png' />
        <img src='https://cdn.plotch.io/image/upload/C/V/1660916612_My5wbmc=.png' />
        <img src='https://cdn.plotch.io/image/upload/C/V/1660916617_NC5wbmc=.png' />
        <img src='https://cdn.plotch.io/image/upload/C/V/1660916629_NS5wbmc=.png' />
      </Box>
